...
public class  FatFoodAdapter extends BaseAdapter {
    ...
    public FatFoodAdapter(Context context, String[] foodNames, TypedArray foodImages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_fat_food, parent, false);
        }
