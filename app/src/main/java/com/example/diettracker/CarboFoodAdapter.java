...
public class CarboFoodAdapter extends BaseAdapter {
    ...
    public CarboFoodAdapter(Context context, String[] foodNames, TypedArray foodImages) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_carbo_food, parent, false);
        }
